...
public:
    ...
    shared_ptr<Object> load_figure(const string &file_name);
    shared_ptr<Scene> load_scene(const string &file_name);
    shared_ptr<Object> load_camera(const string &file_name);
private:
